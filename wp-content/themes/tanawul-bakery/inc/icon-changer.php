...
class tanawul_bakery_Icon_Changer extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="icon-list clearfix">
                    ...
                    <?php
                    $tanawul_bakery_Icon_Changer_array = tanawul_bakery_Icon_Changer_array();
                    foreach ($tanawul_bakery_Icon_Changer_array as $tanawul_bakery_Icon_Changer) {
                            $icon_class = $this->value() == $tanawul_bakery_Icon_Changer ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($tanawul_bakery_Icon_Changer).'"></i>
                            <span class="tanawul-bakery-social-class">'.esc_attr($tanawul_bakery_Icon_Changer).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function tanawul_bakery_icon_customize_js() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'tanawul-bakery-customize-icon', esc_url(get_template_directory_uri()).'/assets/js/customize-icon.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'tanawul_bakery_icon_customize_js' );

if(!function_exists('tanawul_bakery_Icon_Changer_array')){
    function tanawul_bakery_Icon_Changer_array(){
        return array("", 
        "fab fa-500px",
