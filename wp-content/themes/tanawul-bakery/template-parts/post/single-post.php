	 	...
	 	<?php if( get_theme_mod( 'tanawul_bakery_single_post_date',true) != '' || get_theme_mod( 'tanawul_bakery_single_post_comment',true) != '' || get_theme_mod( 'tanawul_bakery_single_post_author',true) != '') { ?>
			<div class="post-info">
				<?php if( get_theme_mod( 'tanawul_bakery_single_post_date',true) != '') { ?>
				    <span class="entry-date text-capitalize"><i class="<?php echo esc_attr(get_theme_mod('tanawul_bakery_post_date_icon_changer','fa fa-calendar')); ?>"></i><a href="<?php echo esc_url( get_day_link( $archive_year, $archive_month, $archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span><?php echo esc_html( get_theme_mod('tanawul_bakery_seperator_metabox') ); ?>
				<?php } ?>
				...
				<?php } ?>
				<?php if( get_theme_mod( 'tanawul_bakery_post_time_show',false) != '') { ?>
