                ...
                <?php if (get_theme_mod( 'tanawul_bakery_slider_button',true) != '' || get_theme_mod( 'tanawul_bakery_show_hide_slider_button',true) != ''){ ?>
                  <?php if( get_theme_mod('tanawul_bakery_slider_button_text','Read More') != ''){ ?>
                    <div class ="readbutton mt-md-4">
                      <span class="p-1"><a href="<?php the_permalink(); ?>"><?php echo esc_html(get_theme_mod('tanawul_bakery_slider_button_text','Read More'));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('tanawul_bakery_slider_button_text','Read More'));?></span></a></span>
                    </div>
                  <?php } ?>
                <?php } ?>
              </div>
